        ...
        <form onSubmit={Form.handleSubmit(setHandleSubmit)} className="flex shadow border rounded-2xl w-full md:w-6xl h-fit py-8 justify-center border-gray-200">
            <div className="flex flex-col gap-4 items-center text-sm md:text-md">
                <div className="flex flex-col gap-2">
                    ...
                    type="text"
                    {...Form.register("name")}
                    className="p-4 w-[200px] h-fit md:w-[640px] border border-gray-400 shadow-xs rounded-xl " />
                </div>
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    type="text"
                    {...Form.register("text")}
                    className="p-4 md:w-[640px] md:h-64 border border-gray-400 shadow-xs rounded-xl " />
                </div>
