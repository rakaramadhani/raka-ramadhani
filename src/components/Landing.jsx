        ...
        <>
            <div className="text-center md:text-left space-y-4">
                ...
                <div className="text-white flex gap-4">
                    <a id="contact" href="#contact" className="p-3 rounded-xl border text-center border-gray-300 bg-primary-light hover:bg-primary ease-in-out w-full cursor-pointer">
                        Get in Touch
                    </a>
                    <a id="project" href="#project" className="text-primary-dark p-3 rounded-xl backdrop-blur-sm border-2 text-center border-gray-400  hover:border-primary ease-in-out w-full cursor-pointer">
                        View Project
                    </a>
                </div>
